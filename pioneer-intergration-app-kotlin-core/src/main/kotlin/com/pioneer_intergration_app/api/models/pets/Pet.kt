...
import com.pioneer_intergration_app.api.core.checkKnown
...
private constructor(
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws PioneerIntergrationAppInvalidDataException if this class instance's value is a
         *   not a known member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw PioneerIntergrationAppInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws PioneerIntergrationAppInvalidDataException if this class instance's value does
         *   not have the expected primitive type.
         */
        fun asString(): String =
            _value().asString()
                ?: throw PioneerIntergrationAppInvalidDataException("Value is not a String")
    ...
    private constructor(
        ...
        /**
         * @throws PioneerIntergrationAppInvalidDataException if the JSON field has an unexpected
