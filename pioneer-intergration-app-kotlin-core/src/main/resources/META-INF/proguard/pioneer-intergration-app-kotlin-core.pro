...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.pioneer_intergration_app.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.pioneer_intergration_app.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.pioneer_intergration_app.api.** {
    <init>(...);
