...
dependencies {
    testImplementation(project(":pioneer-intergration-app-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../pioneer-intergration-app-kotlin-core/src/main/resources/META-INF/proguard/pioneer-intergration-app-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.pioneer_intergration_app.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../pioneer-intergration-app-kotlin-core/src/main/resources/META-INF/proguard/pioneer-intergration-app-kotlin-core.pro",
